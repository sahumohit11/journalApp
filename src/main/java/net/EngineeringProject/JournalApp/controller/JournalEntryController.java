...
package net.EngineeringProject.JournalApp.controller;
        ...
        import net.EngineeringProject.JournalApp.service.JournalEntryService;
...
public class JournalEntryController {
    ...
    @GetMapping("id/{myId}")
    public ResponseEntity<JournalEntry> findJournalEntryById(@PathVariable ObjectId myId){
        Authentication authentication=SecurityContextHolder.getContext().getAuthentication();
        String userName=authentication.getName();
        User user=userService.findByUserName(userName);
